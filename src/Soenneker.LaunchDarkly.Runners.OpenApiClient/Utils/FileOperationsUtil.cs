...
using Soenneker.LaunchDarkly.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.LaunchDarkly.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["LaunchDarkly:ClientGenerationUrl"] ?? "https://app.launchdarkly.com/api/v2/openapi.json";
        ...
        if (filePath == null)
            throw new InvalidOperationException("LaunchDarkly OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "LaunchDarklyOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
